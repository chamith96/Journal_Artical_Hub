                  ...
                  <td class="content-cell">
                    ...
                    <table class="body-action" align="center" width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center">
                          <div>
                            <a href="{{route('sendEmailVerify',["email"=>$user->email, "verifyToken"=>$user->verifyToken])}}" class="button button--blue">Verify Email</a>
                          </div>
                        </td>
                      </tr>
                    </table>
                    <p>Thanks,<br>SUSL Journal Administration</p>
                    <!-- Sub copy -->
